...
export function _waitForSelector(selector, options, page) {
  return function() {
...
export function _contentFrame(elementHandle) {
  return function() {
...
export function _keyboardType(selector, text, options, page) {
  return function() {
